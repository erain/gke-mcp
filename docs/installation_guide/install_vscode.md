# Installing the GKE MCP Server in VSCode

This guide provides detailed steps on how to install and configure the GKE MCP Server for use with Visual Studio Code. This allows you to leverage VSCode's AI capabilities to interact with your GKE clusters using natural language prompts.

## Prerequisites

The GKE MCP Server is a command-line tool. You must have the binary installed on your system before configuring it in VSCode.
...
## Installing via VSCode MCP Extension

The recommended way to use MCP servers in VSCode is through the official MCP Client extension or similar MCP-enabled extensions.
...
1. Restart VSCode after configuring the MCP server
...
## Using GKE MCP in VSCode Chat

Once connected, you can use the VSCode chat interface to interact with your GKE environment:
...
- Review VSCode extension logs for detailed error messages
...
- Check VSCode Developer Tools (Help > Toggle Developer Tools) for extension errors
